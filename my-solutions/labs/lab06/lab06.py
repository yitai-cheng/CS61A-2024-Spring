...
def make_change(amount, coins):
    ...
    # "*** YOUR CODE HERE ***"
        ...
        change_list = make_change(amount - smallest, rest)
        if change_list is None:
            return make_change(amount, rest)
        else:
            return [smallest] + change_list
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        for change_element in change:
            self.coins[change_element] = self.coins[change_element] - 1
            if self.coins[change_element] == 0:
                self.coins.pop(change_element)
